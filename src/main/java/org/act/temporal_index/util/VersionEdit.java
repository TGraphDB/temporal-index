...
public class VersionEdit
{
    ...
    private final Multimap<Integer, IndexMetaData> newFiles = ArrayListMultimap.create();
    ...
    public Multimap<Integer, IndexMetaData> getNewFiles()
    {
    ...
    public void addFile(int level, long fileNumber,
            ...
            int largest)
    {
    	IndexMetaData fileMetaData = new IndexMetaData(fileNumber, fileSize, smallest, largest);
        addFile(level, fileMetaData);
    }

    public void addFile(int level, IndexMetaData fileMetaData)
    {
        newFiles.put(level, fileMetaData);
    }

    public void addFiles(Multimap<Integer, IndexMetaData> files)
    {
