...
public class RNode<C extends Coordinate<? super C>>
{
    ...
    public static <COR extends Coordinate<? super COR>> Comparator<RNode<COR>> getComparator(COR cor, int dimIndex){
        Comparator<? super COR> c = cor.getComparator(dimIndex);
        return new Comparator<RNode<COR>>() {
            @Override
            public int compare(RNode<COR> o1, RNode<COR> o2) {
                return c.compare(o1.center, o2.center);
            }
        };
    }

    public static <C extends Coordinate<? super C>> RNode<C> newInstance(RTree.CoordinateGen<C> coordinateGen) {
